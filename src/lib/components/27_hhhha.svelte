...
<div class="sidebar-right">
	<div class="preset-section">
		<h3 style="margin: 0 0 10px 0; font-size: 1rem; font-weight: 500;">Presets</h3>
		<div class="preset-buttons">
			<button class="preset-btn" onclick={applyPreset1}>Preset 1</button>
			<button class="preset-btn" onclick={applyPreset2}>Preset 2</button>
			<button class="preset-btn" onclick={applyPreset3}>Preset 3</button>
		</div>
	</div>
	...
	<div class="color-amount-section">
		<label class="section-label">Number of Colors (2-7)</label>
